...
class TestHero(TestCase):
  ...
  def test_heroes(self):
    ...
    battle = Battle.objects.create(fighter1=lion,
                                   fighter2=human,
                                   winner_id=lion)
...
class TestHeroView(TestCase):
  ...
  def test_heroes(self):
    ...
    herorank= HeroRank()
    herorank.initialize(lion,
                        lion.get_wins_number(),
                        lion.get_defeats_number()) 
    herorank2= HeroRank()
    herorank2.initialize(human,
                         human.get_wins_number(),
                         human.get_defeats_number())    
    result = []
